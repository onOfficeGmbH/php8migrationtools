...
class StringComparisonArrayKeys extends AbstractRector
{
    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition('replace "array_keys($a, $b)" with "c_arrayKeys($a, $b)"', [new CodeSample(
            <<<'CODE_SAMPLE'
if (array_keys($a, $b))
CODE_SAMPLE
            ,
...
CODE_SAMPLE
    ...
    public function refactor(Node $node): ?Node
    {
        if ($node instanceof FuncCall &&
            ...
            return new FuncCall(new Name('c_arrayKeys'), $node->args);
        }
