...
class Phase2
{
    ...
    {
        $subject = 'Phase 2: Please report to the PHP 8 migration Team';
    ...
    {
        $message = 'Phase 2: Please report to the PHP 8 migration team: $strict was given with value ' . var_export($strict, true);
